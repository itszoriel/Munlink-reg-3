...
import { Shield, Users, FileText, Menu, X, LogOut, ChevronLeft, ChevronRight } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-ocean-50/30 to-forest-50/20">
      ...
      >
          ...
          {isSidebarCollapsed ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="overflow-hidden">
                <h2 className="font-serif font-bold text-gray-900 text-lg whitespace-nowrap">Super Admin</h2>
                <p className="text-xs text-gray-500 whitespace-nowrap">MunLink Portal</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="p-4 border-t border-gray-100">
          <div className={`${isSidebarCollapsed ? 'text-center' : 'flex items-center gap-3'} mb-3`}>
            <div className={`${isSidebarCollapsed ? 'mx-auto' : ''} w-10 h-10 bg-gradient-to-br from-purple-500 to-blue-600 rounded-full flex items-center justify-center text-white font-semibold flex-shrink-0`}>
          ...
          <aside className="absolute left-0 top-0 bottom-0 w-[280px] bg-white flex flex-col shadow-2xl">
            ...
            <div className="p-6 border-b border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-serif font-bold text-gray-900 text-lg">Super Admin</h2>
                  <p className="text-xs text-gray-500">MunLink Portal</p>
                </div>
              </div>
              <button
                onClick={() => setIsMobileSidebarOpen(false)}
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 z-30">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-serif font-bold text-gray-900">Super Admin</span>
        </div>
