        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            ...
            className={`text-center mb-12 transition-all duration-700 ${
              municipalitiesRef.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
            }`}
          >
            ...
            <div className="relative -mx-8 px-8">
              <ScrollVelocity baseVelocity={3}>
                {zambalesMunicipalities.map((mun) => (
                  <span
                    key={mun.slug}
                    className={`inline-flex text-sm px-4 py-2 rounded-full transition-all mx-2 ${
                      mun.isCapital
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  ref={featureRef.ref}
                  className={`text-center bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-500 hover:-translate-y-1 ${
                    featureRef.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
                  }`}
